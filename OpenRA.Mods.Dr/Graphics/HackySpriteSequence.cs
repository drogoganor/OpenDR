...
namespace OpenRA.Mods.Dr.Graphics
{
	public class HackySpriteSequenceLoader : ISpriteSequenceLoader
	{
		...
		public HackySpriteSequenceLoader(ModData modData) { }
	...
	public class HackySpriteSequence : ISpriteSequence
	{
		...
		{
			var f = Common.Util.QuantizeFacing(facing, Facings, useClassicFacingFudge);
			if (reverseFacings)
				f = (Facings - f) % Facings;
