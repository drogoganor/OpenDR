...
{
	public class WithDrDockingAnimationInfo : TraitInfo<WithDockingAnimation>, Requires<WithSpriteBodyInfo>, Requires<FreighterInfo>
	{
		[SequenceReference]
	...
	public class WithDrDockingAnimation { }
}
