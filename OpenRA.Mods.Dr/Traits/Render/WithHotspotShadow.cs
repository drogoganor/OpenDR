...
namespace OpenRA.Mods.Common.Traits.Render
{
	...
	public class WithHotspotShadowInfo : PausableConditionalTraitInfo, IRenderActorPreviewSpritesInfo, Requires<RenderSpritesInfo>, Requires<BodyOrientationInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new WithHotspotShadow(init.Self, this); }
	...
	public class WithHotspotShadow : PausableConditionalTrait<WithHotspotShadowInfo>, ITick, ITickRender
	{
		readonly Animation overlay;

        WVec bodyHotspot;

		public WithHotspotShadow(Actor self, WithHotspotShadowInfo info)
			: base(info)
		{
        ...
        {
            int currentFrame = overlay.CurrentFrame;
        }
    }
}
