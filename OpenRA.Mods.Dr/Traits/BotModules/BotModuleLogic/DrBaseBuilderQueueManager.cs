...
{
	class DrBaseBuilderQueueManager
	{
		readonly string category;

		readonly DrBaseBuilderBotModule baseBuilder;
		...
		public DrBaseBuilderQueueManager(DrBaseBuilderBotModule baseBuilder, string category, Player p, PowerManager pm,
