...
namespace OpenRA.Mods.Dr.AudioLoaders
{
	public class Wav : ISoundLoader
	{
	...
	public sealed class WavFormat : ISoundFormat
	{
		...
		public float LengthInSeconds { get { return Common.FileFormats.WavReader.WaveLength(sourceStream); } }
		...
		public WavFormat(Stream stream)
		{
			...
			if (!FileFormats.WavReader.LoadSound(stream, out wavStreamFactory, out channels, out sampleBits, out sampleRate))
